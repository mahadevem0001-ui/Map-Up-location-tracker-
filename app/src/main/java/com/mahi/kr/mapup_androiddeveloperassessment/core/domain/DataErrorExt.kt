...
import com.mahi.kr.mapup_androiddeveloperassessment.core.presentation.UiText

/**
 * Extension function to map DataError to UiText
 * Converts domain errors to user-facing localized error messages
 */
